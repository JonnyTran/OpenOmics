                    ...
                    dcc.Tab(
                        ...
                        children=html.Div(
                            ...
                            children=[
                                html.H5(
                                    className="what-is",
                                    children="OpenOmics: The Multi-Omics Explorer",
                                ),
                                html.P(
                                    "OpenOmics provides a bioinformatics API and web-app "
                                ...
                                html.Div(
                                    [
                                        ...
                                        html.A(
                                            "OpenOmics GitHub",
                                            href="https://github.com/JonnyTran/OpenOmics.git",
                                        ),
                                        ".",
                                    ]
                                ),
                        ...
                        children=[
                            ...
                            html.Div(
                                ...
                                children=[
                                    ...
                                    dcc.Dropdown(
                                        id="clinical-patient-col-name", disabled=True
                                    ),
                        ...
                        children=[
                            ...
                            html.Div(
                                ...
                                children=[
                                    ...
                                    dcc.Dropdown(
                                        id="data-table-genes-col-name", disabled=True
                                    ),
                                    html.Div(["Select the column prefixes to import:"]),
                                    dcc.Dropdown(
