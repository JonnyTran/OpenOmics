...
class SingleNucleotideVariants(ExpressionData, Annotatable):
    def __init__(self,
        ...
        Args:
            ...
            cohort_name:
        """
        super(SingleNucleotideVariants,
...
class SomaticMutation(ExpressionData, Annotatable):
    def __init__(self,
        ...
        Args:
            ...
            cohort_name:
        """
        super(SomaticMutation, self).__init__(data=data,
                                              transpose=transpose,
                                              gene_index=gene_index,
                                              usecols=usecols,
                                              gene_level=gene_level,
...
class DNAMethylation(ExpressionData, Annotatable):
    def __init__(self,
        ...
        Args:
            ...
            cohort_name:
        """
        super(DNAMethylation, self).__init__(data=data,
                                             transpose=transpose,
                                             gene_index=gene_index,
                                             usecols=usecols,
                                             gene_level=gene_level,
...
class CopyNumberVariation(ExpressionData, Annotatable):
    def __init__(self,
        ...
        Args:
            ...
            cohort_name:
        """
        super(CopyNumberVariation, self).__init__(data=data,
                                                  transpose=transpose,
                                                  gene_index=gene_index,
                                                  usecols=usecols,
                                                  gene_level=gene_level,
