    ...
    def __init__(
        ...
        **kwargs
        ...
        if file_resources is None:
            ...
            file_resources[
                "MalaCards.csv"
            ] = "download.action.php?filename=DataDownload/MalaCards.csv"

        super(MalaCards, self).__init__(
            path, file_resources, col_rename=col_rename, **kwargs
        )
...
class HMDD(DiseaseAssociation):
    COLUMNS_RENAME_DICT = {"mir": "gene_name", "disease": "disease_associations"}
    ...
    def load_dataframe(self, file_resources, npartitions=None):
        ...
        """
        df = pd.read_csv(
            file_resources["alldata.txt"], sep="\t", encoding="unicode_escape"
        )
...
class LncRNADisease(DiseaseAssociation):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LncRNADisease, self).__init__(
            path, file_resources, col_rename=col_rename, **kwargs
        )
